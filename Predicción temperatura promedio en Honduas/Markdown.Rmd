...
```{r}
g1 = autoplot(object = diff(diff(train,12)),
              main = "Serie diferenciada de temperatura promedio en Honduras", 
              y = "Celsius", x = "Años")
...
## Modelo 1
$$
 Temperatura \sim SARIMA(2,1,1)_\times(1,1,1)_{12}\\
 \mu_0 \sim t(0,2.5,7)\\
 \sigma_0 \sim t(7)\\
...
$$
 Temperatura \sim SARIMA(1,1,1)_\times(1,1,1)_{12}\\
 \mu_0 \sim t(0,2.5,7)\\
 \sigma_0 \sim t(7)\\
